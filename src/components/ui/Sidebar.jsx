...
import {
    BookOpen, Layout, FileText, PenTool,
    BarChart2, Bell, LogOut, ChevronLeft, X
} from 'lucide-react';
            ...
            `}>
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex items-center justify-between px-6 py-4 h-16">
                        <span className={`text-emerald-600 text-xl font-bold transition-all duration-300
                            ${!isOpen && 'lg:hidden'}`}>
                            LMS Portal
                        </span>
                    ...
                    <div className="p-3 border-t border-gray-200">
                        <button className="flex items-center w-full px-4 py-2 text-gray-600 hover:bg-gray-100 hover:text-red-500 rounded-lg transition">
