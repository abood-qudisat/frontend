...
import { Users, BookOpen, UserCheck, BarChart3, PlusCircle, ClipboardList } from "lucide-react";
                ...
                <div className="px-6 py-10 max-w-7xl mx-auto space-y-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white shadow-md rounded-xl p-5 flex items-center gap-4 border-l-4 border-emerald-600">
                            ...
                            <div>
                                <h2 className="text-xl font-semibold text-black">{stats.users}</h2>
                        ...
                        <div className="bg-white shadow-md rounded-xl p-5 flex items-center gap-4 border-l-4 border-indigo-600">
                            ...
                            <div>
                                <h2 className="text-xl font-semibold text-black">{stats.instructors}</h2>
                        ...
                        <div className="bg-white shadow-md rounded-xl p-5 flex items-center gap-4 border-l-4 border-yellow-500">
                            ...
                            <div>
                                <h2 className="text-xl font-semibold text-black">{stats.courses}</h2>
                                <p className="text-sm text-gray-500">Courses</p>
                            </div>
                        </div>

                        <div className="bg-white shadow-md rounded-xl p-5 flex items-center gap-4 border-l-4 border-red-500">
                            <ClipboardList className="w-8 h-8 text-red-500" />
                            <div>
                                <h2 className="text-xl font-semibold text-black">{stats.reports}</h2>
                    ...
                    disabled:transform-none flex items-center gap-3">
                        ...
                        <button className="bg-gradient-to-r from-indigo-600 to-indigo-600 text-white py-3 px-6 rounded-lg font-medium 
                    ...
                    disabled:transform-none flex items-center gap-3">
                        ...
                        <button className="bg-gradient-to-r from-yellow-600 to-yellow-600 text-white py-3 px-6 rounded-lg font-medium 
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-md">
                        <h3 className="text-lg font-semibold text-gray-800 mb-2">User Growth (Coming Soon)</h3>
