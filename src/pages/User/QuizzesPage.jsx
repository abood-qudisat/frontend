...
const QuizzesPage = () => {
  ...
  const fetchQuizzes = async () => {
    const { data, success } = await get(`quizzes`);
    if (success) {
      console.log("====================================");
        ...
        <div className="px-6 py-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Review your quizzes and scores, and check upcoming quizzes.
            </p>
          </div>
            ...
            {quizzes.map((quiz) => (
              ...
              >
                ...
                <div className="flex justify-between items-center mt-3">
                  ...
                  <button
                    className={`text-sm ${
                      quiz.status == "pending" ? "text-grey" : "text-white"
                    } bg-emerald-600 hover:bg-emerald-700 px-4 py-1.5 rounded-lg transition`}
